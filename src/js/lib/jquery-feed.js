...
JAtom.prototype = {
    ...
    _parse: function(xml) {
        ...
        $('entry', xml).each( function(index, value) {
            ...
            var mediaThumbnail = $(this).find("media\\:thumbnail").eq(0);
            var thumbnail = $(mediaThumbnail).attr('url');


            // var thumbnail = $(this).find('media\\:thumbnail').eq(0).text();
            // var thumbnail = $(this).find("media\\:thumbnail")[0];
            // var img = $(thumbnail).attr('url');
...
JRss.prototype  = {
    ...
    _parse: function(xml) {
        ...
        $('item', xml).each( function(index, value) {
            ...
            var media = $(xmlText).find("media\\:thumbnail")[0];
            item.thumbnail = $(media).attr('url');
