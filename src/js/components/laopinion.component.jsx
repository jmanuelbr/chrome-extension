...
if (process.env.NODE_ENV === 'development') {
    getMockData = require('../mocks/laopinion.mocks').getMockData;
}

class LaOpinionWidget extends NewsUpdatableWidget {
    constructor(props) {
        super(props);
        this.PROPERTIES = {
            feedUrl: "https://www.laopiniondemurcia.es/rss/section/20510"
        };
    ...
    getArticles(jsonData) {
        ...
        try {
            ...
            super.loading(false);
            console.error('*** EXCEPTION La Opinion component (I could not parse all articles) -> ', exception);
        }
        return list;
    };
...
export default connect(LaOpinionWidget);
