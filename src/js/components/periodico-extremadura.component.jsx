...
if (process.env.NODE_ENV === 'development') {
    getMockData = require('../mocks/periodico-extremadura.mocks').getMockData;
}

class PeriodicoExtremaduraWidget extends NewsUpdatableWidget {
    constructor(props) {
        super(props);
        this.PROPERTIES = {
            feedUrl: "https://www.elperiodicoextremadura.com/rss/section/25000"
        };
    ...
    getArticles(jsonData) {
        ...
        try {
            ...
            super.loading(false);
            console.error('*** EXCEPTION PeriodicoExtremadura component (I could not parse all articles) -> ', exception);
        }
        return list;
    };
...
export default connect(PeriodicoExtremaduraWidget);
